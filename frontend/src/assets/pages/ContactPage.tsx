        ...
        <main className="font-poppins grid grid-cols-1 md:grid-cols-2 min-h-[calc(100vh-116px)] w-full relative z-10">
          ...
          >
            ...
            <p className="text-sm md:text-base text-gray-700 leading-relaxed max-w-full text-justify">
              Need something built or want to discuss a project? I'm open to new opportunities and collaborations.
              Reach out for consulting, development, or product design support, and I'll respond quickly with the right solution.
            </p>
          </motion.div>
